...
class Liftmode_ReferralCandy_Model_ReferralCandy {
    ...
    public function __construct(array $options)
    {
        if (isset($options['access_id'])) {
            ...
            throw new Exception("Passed parameter 'access_id' is wrong.");
        }

        if (isset($options['secret_key'])) {
            $this->secret_key = $options['secret_key'];
        } else {
            throw new Exception("Passed parameter 'secret_key' is wrong.");
        }
    }
